                    ...
                    <tr key={day}>
                      ...
                      {PERIODS.map((period) => {
                        ...
                        return (
                          <td
                            key={period}
                            className={`border border-border p-1 ${isIA ? 'bg-amber-50 dark:bg-amber-900/20' : 'cursor-pointer hover:bg-accent/50'} transition-colors h-16`}
                            onClick={() => !isIA && handleCellClick(dayIdx + 1, period)}
                          >
                            {isIA ? (
